    ...
    <SafeScreen>
      ...
      {addresses.length === 0 ? (
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text className="text-text-primary mt-4 text-xl font-semibold">No addresses yet</Text>
          <Text className="text-text-secondary mt-2 text-center">
            Add your first delivery address
          </Text>
          <TouchableOpacity
            className="bg-primary mt-6 rounded-2xl px-8 py-4"
            activeOpacity={0.8}
            onPress={handleAddAddress}
          >
            <Text className="text-background text-base font-bold">Add Address</Text>
          </TouchableOpacity>
        </View>
      ) : (
        <ScrollView
        ...
        >
          <View className="px-6 py-4">
            ...
            <TouchableOpacity
              className="bg-primary mt-2 items-center rounded-2xl py-4"
              activeOpacity={0.8}
              onPress={handleAddAddress}
            >
              <View className="flex-row items-center">
                <Ionicons name="add-circle-outline" size={24} color="#121212" />
                <Text className="text-background ml-2 text-base font-bold">Add New Address</Text>
              </View>
            </TouchableOpacity>
          </View>
        </ScrollView>
