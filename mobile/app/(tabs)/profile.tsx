    ...
    <SafeScreen>
      ...
      >
        ...
        <View className="px-6 pb-8">
          <View className="rounded-3xl p-6 text-zinc-900">
            <View className="flex-row items-center">
              <View className="relative">
                <Image
                  ...
                  transition={200}
                />
                <View className="absolute -bottom-1 -right-1 size-7 items-center justify-center rounded-full border-2 border-white text-zinc-900">
        ...
        <View className="mx-6 mb-3 flex-row flex-wrap gap-2">
          {MENU_ITEMS.map((item) => (
            <TouchableOpacity
              key={item.id}
              className="items-center justify-center rounded-2xl p-6 text-zinc-900"
              style={{ width: '48%' }}
              activeOpacity={0.7}
        ...
        {/* NOTIFICATONS BTN */}
        <View className="mx-6 mb-3 rounded-2xl p-4 text-zinc-900">
          <TouchableOpacity
        ...
        {/* SIGNOUT BTN */}
        <TouchableOpacity
          className="mx-6 mb-3 flex-row items-center justify-center rounded-2xl border-2 border-red-500/20 py-5 text-zinc-900"
          activeOpacity={0.8}
          onPress={() => signOut()}
        >
